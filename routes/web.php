...
use Freshbitsweb\LaravelGoogleAnalytics4MeasurementProtocol\Http\Controllers\StoreGoogleAnalyticsSessionNumberController;
...
Route::post('store-google-analytics-session-number', StoreGoogleAnalyticsSessionNumberController::class)->middleware('web');